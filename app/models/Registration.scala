...
object Registration {
   ...
   * 
   * Finding no match is interpreted as an error and will return a {@link NoSuchElementException} within a 
   * {@link Failure}.
   * 
   * @param link The link to identify the registration with.
   * @returns A {@link Validation} holding the registration that was matched or the {@link Throwable} in case of error.
   */
   ...
   * 
   * @param id The identifier of the {@link Registration} to delete.
   * @returns A {@link Validation} holding the number of items that were deleted or the {@link Throwable} in case of 
   *          error.
   */
...
/**
 * Database functionality for {@link Registration}.
 */
